...
import types, os, re, cgi, sys, time, datetime, functools, mimetypes, threading, logging, urllib.parse, traceback
...
class WSGIApplication(object):
    ...
    def get_wsgi_application(self, debug=False):
        ...
        _application = Dict.Dict(document_root=self._document_root)
